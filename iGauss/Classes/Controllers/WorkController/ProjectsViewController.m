...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.projectId = 1;
    cell.projectName.text = [NSString stringWithFormat:@"This is a dummy project with an id %d", indexPath.row];
...
{
    self.model.projectName = ((ProjectCell *)[tableView cellForRowAtIndexPath:indexPath]).projectName.text;
